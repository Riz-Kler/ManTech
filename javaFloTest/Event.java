...
public class Event {
	...
	public void addEvent() {
		...
		try{
		    ...
		    stmt = conn.createStatement();
		    String sql;
		    sql = "INSERT INTO Event(id,name,description,date,time,pictures,eventcreator,eventartist,eventcategory) VALUES (1,'"+name+"', '"+descr+"', '"+date+"', '"+time+"', '"+picurl+"', '"+eventCreator+"', '"+eventArtist+"', '"+eventCategory+"')"; 
